...
CREATE TABLE "work_order_files" (
    ...
    CONSTRAINT "FileUpload_workOrderId_fkey" FOREIGN KEY ("work_order_id") REFERENCES "WorkOrder" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "FileUpload_uploaderId_fkey" FOREIGN KEY ("uploader_id") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Account_provider_providerAccountId_key" ON "accounts"("provider", "providerAccountId");
...
-- CreateIndex
CREATE UNIQUE INDEX "VerificationToken_token_key" ON "verification_tokens"("token");
...
-- CreateIndex
CREATE INDEX "FileUpload_workOrderId_idx" ON "work_order_files"("workOrderId");
